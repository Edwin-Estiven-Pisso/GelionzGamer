...
public class User {
    ...
    public User(int id, String username, String email, String nombres, String apellidos, String documento, String celular, String genero, Boolean usuario_activo, String rol_de_usuario, String password) {
        this.id = id;
